...
type CreateShippingResponse struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	DeliveryTimeDays int32                  `protobuf:"varint,1,opt,name=delivery_time_days,json=deliveryTimeDays,proto3" json:"delivery_time_days,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CreateShippingResponse) GetDeliveryTimeDays() int32 {
	if x != nil {
		return x.DeliveryTimeDays
	}
	return 0
}
...
const file_shipping_shipping_proto_rawDesc = "" +
	...
	"\x05items\x18\x02 \x03(\v2\x16.shipping.ShippingItemR\x05items\"M\n" +
	"\fShippingItem\x12!\n" +
	"\fproduct_code\x18\x01 \x01(\tR\vproductCode\x12\x1a\n" +
	"\bquantity\x18\x02 \x01(\x05R\bquantity\"F\n" +
	"\x16CreateShippingResponse\x12,\n" +
	"\x12delivery_time_days\x18\x01 \x01(\x05R\x10deliveryTimeDays2W\n" +
	"\bShipping\x12K\n" +
	"\x06Create\x12\x1f.shipping.CreateShippingRequest\x1a .shipping.CreateShippingResponseB7Z5github.com/ruandg/microservices-proto/golang/shippingb\x06proto3"
...
var file_shipping_shipping_proto_goTypes = []any{
	...
	(*ShippingItem)(nil),           // 1: shipping.ShippingItem
	(*CreateShippingResponse)(nil), // 2: shipping.CreateShippingResponse
}
var file_shipping_shipping_proto_depIdxs = []int32{
	1, // 0: shipping.CreateShippingRequest.items:type_name -> shipping.ShippingItem
	0, // 1: shipping.Shipping.Create:input_type -> shipping.CreateShippingRequest
